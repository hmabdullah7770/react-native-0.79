...
// // Global state for tracking requests - ADD THIS
...
//    console.log("base url is", Baseurl())
//   const credentials = await Keychain.getGenericPassword({ service: 'accessToken'});
//     console.log("get acces token function :", credentials.password)
//     return credentials.password 
...
// // ADD THESE CLEAR API FUNCTIONS
// // Clear all pending requests and state
// export const clearApiState = () => {
//   // console.log('🧹 Clearing API state...');
//   // console.log(`📊 Current state - isRefreshing: ${isRefreshing}, failedQueue: ${failedQueue.length}, requestTracker: ${requestTracker.size}`);
...
//     pendingRequests: Array.from(requestTracker.entries()).filter(([_, req]) => req.status === 'pending'),
